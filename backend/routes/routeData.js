...
router.route('/').get(protect, getData).post(setData) // GET + POST -- The lack of middleware here allows anyone to get or post data without being authorized. this must be resolved prior to launch.
